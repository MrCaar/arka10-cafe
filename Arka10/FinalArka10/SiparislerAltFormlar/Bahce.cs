...
namespace FinalArka10.SiparislerAltFormlar
{
    public partial class Bahce : Form
    {
        ...
        public Bahce(FormAnaMenu mainMenu)
        {
            InitializeComponent();
        ...
        //{
        //    // Şu anda bahçedesiniz, işlem yapmayabilir veya log yazabilirsiniz.
        //}

        //private void salonBtn_Click(object sender, EventArgs e)
        //{
        //    // FormAnaMenu üzerinden Siparişler ve ardından Salon formunu açabilirsiniz.
        ...
        //{
        //    // FormAnaMenu üzerinden Siparişler ve ardından Teras formunu açabilirsiniz.
        ...
        private void BahceBtn2_Click(object sender, EventArgs e)
        {
            // Şu anda bahçedesiniz, işlem yapmayabilir veya log yazabilirsiniz.
        }


        private void TerasBtn2_Click_1(object sender, EventArgs e)
        {
            // FormAnaMenu üzerinden Siparişler ve ardından Teras formunu açabilirsiniz.
            mainMenuForm.OpenChieldForm(new SiparislerAltFormlar.Teras(mainMenuForm), sender);
        }

        private void Bahce_Load(object sender, EventArgs e)
        {
            ...
            DataTable masalarTable = DatabaseHelper.GetTables("bahce"); // GetTables fonksiyonundan masaları al
