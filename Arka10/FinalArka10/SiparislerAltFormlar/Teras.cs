...
{
    public partial class Teras : Form
    {
        private readonly FormAnaMenu mainMenuForm;

        public Teras(FormAnaMenu mainMenu)
        {
            InitializeComponent();
        ...
        {
            // Şu anda Teras formundasınız, işlem yapmayabilir veya log yazabilirsiniz.
        }
        ...
        {
            // FormAnaMenu üzerinden Salon formunu açabilirsiniz.
            mainMenuForm.OpenChieldForm(new SiparislerAltFormlar.Salon(mainMenuForm), sender);
        }

        private void Teras_Load(object sender, EventArgs e)
        {
            ...
            DataTable masalarTable = DatabaseHelper.GetTables("teras"); // GetTables fonksiyonundan masaları al
